...
export default [
  {
    ...
    settings: {
      'boundaries/elements': [
        ...
        { type: 'lib-traces', pattern: 'src/lib/traces' },
        { type: 'lib-logs', pattern: 'src/lib/logs' },
    ...
    rules: {
      ...
      'boundaries/element-types': [
        'error',
        {
          default: 'disallow',
          rules: [
            { from: 'panels', allow: ['panels', 'lib-promql', 'lib-config', 'lib-echarts', 'lib-url-state', 'lib-auto-refresh', 'lib-traces', 'lib-logs', 'components'] },
            ...
            { from: 'lib-traces', allow: ['lib-url-state'] },
            { from: 'lib-logs', allow: ['lib-url-state'] },
            { from: 'app', allow: ['panels', 'lib-promql', 'lib-config', 'lib-url-state', 'lib-auto-refresh', 'lib-echarts', 'lib-traces', 'lib-logs', 'components'] },
