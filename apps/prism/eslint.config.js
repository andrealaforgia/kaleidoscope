    ...
    rules: {
      ...
      'boundaries/element-types': [
        'error',
        {
          default: 'disallow',
          rules: [
            { from: 'panels', allow: ['panels', 'lib-promql', 'lib-config', 'lib-echarts', 'lib-url-state', 'lib-auto-refresh', 'lib-traces', 'components'] },
            ...
            { from: 'app', allow: ['panels', 'lib-promql', 'lib-config', 'lib-url-state', 'lib-auto-refresh', 'lib-echarts', 'lib-traces', 'components'] },
