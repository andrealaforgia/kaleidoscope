...
`/tmp/foo.ndjson` whose contents interleave `lumen.ingest.count`
...
- The new acceptance test's happy-path scenario passes green, asserting
  ...
  `lumen.ingest.count` lines the Lumen feature already
  produces (OK7).
